...
void setup() {
  ...
  Serial.println("initializing PMT, VA is a valid response... ");
...
//  Serial2.write(0xB0);
  ...
  //Serial2.write('P');Serial2.write(0xff);Serial2.write('\r');delay(2000);  //integration time
  
  Serial2.write(0x50);Serial2.write(0x5A);Serial2.write(0x0D);delay(2000);//P33\r
  while(Serial2.available()){Serial.write(Serial2.read());}
  Serial.println();
//  Serial.print("setting voltage... ");
//  Serial2.write('V');Serial2.write(highByte(1200));Serial2.write(lowByte(1200));Serial2.write('\r');delay(2000);   //votage
//  while(Serial2.available()){Serial.write(Serial2.read());}
//  Serial.println();
  Serial.print("starting continueous read... ");
  Serial2.write('C');Serial2.write('\r');delay(2000);   //start continuous read
  Serial.println();
  Serial.println("PMT ready");
...
void setMotorSpeed(String com){
    ...
    if(com[0]=='R'){
      ...
      int spd = comTemp.toInt();//atoi(comTemp.c_str());
  
//      if(spd==0){
//        Serial.print("invalid command: ");
//        Serial.println(com);
//        Serial.println("motor index (a,b,c or d) followed by 12 bit speed (1 to 4095)");
//        return;
//      }
      ...
      if(com[0]=='a'){
      ...
      else if(com[0]=='A'){         // sets speed of all motors                                                         
          ...
          while(Serial2.available()){Serial2.read();}
          Serial2.write(0x0D);
          Serial2.write(0x50);Serial2.write(spd);Serial2.write(0x0D);delay(2000);   // sending command (between 1 and 100)
          Serial.print("Value: ");Serial.print(spd,HEX);Serial.println();
          Serial.print("setting integration: ");Serial.print(com);// user feedback
          Serial.print(" ");
          while(Serial2.available()){Serial.write(Serial2.read());}               // reading response VA is valid BA or BC is incorrect        
          Serial.println();
          Serial2.write('C');Serial2.write('\r');delay(100);                      // restarting continuous read
          ...
          while(Serial2.available()){Serial2.read();}
          Serial2.write(0x0D);
          Serial2.write(0x56);Serial2.write(highByte(spd));Serial2.write(lowByte(spd));Serial2.write('\r');delay(2000);   // sending command (between 1 and 1200)         
          Serial.print("setting voltage: ");Serial.print(com);                    
          Serial.print(" ");
          while(Serial2.available()){Serial.write(Serial2.read());}               // reading response VA is valid BA or BC is incorrect  
          Serial.println();
          Serial2.write('C');Serial2.write('\r');delay(100);                      // restarting continuous read
      ...
      else if(com[0]=='D'){       // reseting to default voltage                                            
          Serial2.write('D');Serial2.write(0x0D);delay(2000);            // sending command
          Serial.print("default ");                                     // user feedback
          while(Serial2.available()){Serial.write(Serial2.read());}     // reading response VA is valid BA or BC is incorrect
          Serial.println();
          Serial2.write('C');Serial2.write('\r');delay(100);            // restarting continuous read
          Serial.print("starting reading ");
